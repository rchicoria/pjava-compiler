...
is_s_expression* insert_s_expression_exp( is_expression* var );
...
is_for* insert_for(int line, is_statement_list* attr, is_b_expression* ibe, is_statement_list* last, is_statement_list* stt);
